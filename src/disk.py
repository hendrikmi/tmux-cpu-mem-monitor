...
if __name__ == "__main__":
    ...
    group.add_argument("-t", "--total", action="store_true", default=False, help="display disk usage as used/total in GB")
    group.add_argument("-f", "--free", action="store_true", default=False, help="display free disk in GB")
    parser.add_argument("-p", "--path", type=str, default=None, help="path to check disk usage")
